...
KHK = Faction(
    ...
    allies=[],
    enemies=[],
    hostiles=["ALI", "ANT", "ARG", "DUC", "FAF", "FRF", "PAR", "HAT", "HOP", "MIN", "RIP", "SCA", "PIO", "TEL", "TER", "YOU", "VIG", "XEN", "YAK", "ZYA"],
)
MIN = Faction(
    tag="MIN",
    race=TELADI,
...
XEN = Faction(
    ...
    allies=[],
    enemies=["YAK"],
    hostiles=["ALI", "ANT", "ARG", "DUC", "FAF", "FRF", "PAR", "HAT", "HOP", "MIN", "RIP", "SCA", "PIO", "TEL", "TER", "YOU", "VIG", "ZYA"],
)
YAK = Faction(
    tag="YAK",
    race=ARGON,
    ...
    allies=[],
    enemies=["PIO", "XEN"],
    hostiles=["ALI", "ANT", "ARG", "DUC", "FAF", "FRF", "PAR", "HAT", "HOP", "KHK", "MIN", "RIP", "SCA", "TEL", "TER", "YOU", "VIG", "ZYA"],
)
ZYA = Faction(
    tag="ZYA",
    race=SPLIT,
